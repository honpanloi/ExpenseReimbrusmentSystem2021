	...
	xhr.onreadystatechange = function(){
		if(xhr.readyState === 4 && xhr.status === 200){
			...
			for (e of allEmployees){
				...
				let direct_manager_empl_id_dis = document.createElement("p")
				direct_manager_empl_id_dis.className = d
				direct_manager_empl_id_dis.textContent = "Employee's direct manager"
				...
				let direct_manager_empl_id_info = document.createElement("p")
				direct_manager_empl_id_info.className = i
				direct_manager_empl_id_info.textContent = e["direct_manager_empl_id"]
				...
				single_div.append(direct_manager_empl_id_dis)
				single_div.append(direct_manager_empl_id_info)
